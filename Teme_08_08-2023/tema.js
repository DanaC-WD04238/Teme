...
const persDanielaCotiga = {
    ...
    prenume: 'Daniela',
    imageSrc: './Dana.jpg',
    descriere: 'Locuiesc in Braila, imi place sa calatoresc impreuna cu familia mea, iubesc animalele si imi place inotul.',
    portofoliuLista: ['Order-Summary', 'Huddle_landing-card', 'News-homepage-card', 'Profile_card', 'Result-Summary-Card', 'Order_summary', 'Fyli-landing-card', 'Homeworks', 'Robot-site', 'Space-tourism', 'Final Project'],
    cunostinteLista: ['Html: List, Tables, Div & Span, Forms, IFrame, Audio & Video', 'Css: Colors, Backgrounds, Selectors, Margin, Border, Padding, Box sizing, Text, Fonts, Position, Display, Css-responsive, Css-Flex, Css-Grid', 'Javascript: Output, Input, If_Else, For Loops, While Loops, let & const, Array, Function, For Each, Map, Filter, Reduce, Find', 'Angular(in progress)']
}
