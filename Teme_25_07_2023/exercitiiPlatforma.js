...
const findMax2 = function() {
    const n1 = parseFloat(prompt("Introduceți primul număr:"));
    const n2 = parseFloat(prompt("Introduceți al doilea număr:"));
    const n3 = parseFloat(prompt("Introduceți al treilea număr:"));

    if (isNaN(n1) || isNaN(n2) || isNaN(n3)) {
      document.getElementById('max2').innerText = 'Introduceți numere valide';
    } else {
      const maxNumber2 = maxBetween3Numbers(n1, n2, n3);
